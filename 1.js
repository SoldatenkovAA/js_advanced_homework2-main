...
const duplicate = ['Властелин колец', 'Хоббиты', 'Война и мир', 'Доктор Стрэндж', 'Медный всадник'];
const withoutDuplicate = ['Властелин колец', 'Хоббиты', 'Война и мир', 'Доктор Стрэндж'];
...
library.addBooks('Рудин');
//library.addBooks('Игрок'); //Error: Такая книга уже добавлена!
console.log(library.allBooks);

library.removeBook('Медный всадник');
//library.removeBook('Подросток'); //Error: Такой книги нет!
console.log(library.allBooks);

console.log(library.hasBook('Доктор Стрэндж'));
console.log(library.hasBook('Обыкновенная история'));